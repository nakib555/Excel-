    ...
    return (
        ...
        >
            <div className="flex flex-col py-1">
                <Tooltip content="Delete cells" side="right">
                    <button 
                ...
                <Tooltip content="Delete sheet rows" side="right">
                    <button 
                ...
                <Tooltip content="Delete sheet columns" side="right">
                    <button 
                ...
                <Tooltip content="Delete sheet" side="right">
                    <button 
