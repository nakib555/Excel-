        ...
        <SmartDropdown
            ...
            trigger={
                <div className="flex items-center gap-0 h-full">
                    {/* Split Button: Main Action (SUM) - Stop propagation to prevent dropdown toggle */}
                    ...
                    {/* Split Button: Dropdown Arrow - Let bubble to SmartDropdown wrapper */}
                    <button 
